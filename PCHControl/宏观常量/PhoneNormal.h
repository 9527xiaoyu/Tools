...
#define kNavStatuBarHeight kStatusBarHeight + 44

//#define kNavStatuBarHeight (IS_IPHONE_X_OR_MORE ? 88.f :64.f)

#define kDefaultNavBarHeight (IS_IPHONE_X_OR_MORE ? 88.0 : ((kSystemVersion < 7.0) ? 44.0 : 64.0))
