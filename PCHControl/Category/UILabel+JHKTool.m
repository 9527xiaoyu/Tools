...
- (CGFloat)fitLabelWidth
{
    ...
    CGSize size = [label.text boundingRectWithSize:CGSizeMake(MAXFLOAT, label.size.height) options:NSStringDrawingTruncatesLastVisibleLine|NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin attributes:dict context:nil].size;
    return size.width;
}
