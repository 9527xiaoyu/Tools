...
+ (UIImage *)scale3xImage:(UIImage *)img size:(CGSize)size
{
    ...
    // 绘制改变大小的图片
    UIGraphicsBeginImageContext(CGSizeMake(kScreenW*3.0, size.height*3.0*kScreenW/size.width));
    [img drawInRect:CGRectMake(0,0, kScreenW*3.0, size.height*3.0*kScreenW/size.width)];
