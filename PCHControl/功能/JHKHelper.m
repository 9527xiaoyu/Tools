...
+(UIView *)showDrawUIviewWithtitle:(NSString *)boby{
    UIView *selfview = [[UIView alloc]initWithFrame:CGRectMake(0, 0, kScreenW, kScreenH)];
    selfview.backgroundColor = [UIColor blackColor];
    selfview.alpha = 0.1;
    UIView *view = [[UIView alloc]initWithFrame:CGRectMake((kScreenW-200)/2.0, (kScreenH-150-64)/2.0, 200, 150)];
